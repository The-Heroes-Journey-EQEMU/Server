...
#undef PutFieldN
	...
	ENCODE(OP_ItemPreviewRequest)
	{
		...
		*p = nullptr;
		...
		EQ::InternalSerializedItem_Struct* int_item = (EQ::InternalSerializedItem_Struct*)in_buf;
...
// file scope helper methods
	...
	void SerializeItem(EQ::OutBuffer& ob, const EQ::ItemInstance *inst, int16 slot_id_in, uint8 depth, ItemPacketType packet_type)
	{
		...
		strn0cpy(
				hdr.unknown000,
				fmt::format("{:016}\0", packet_type == ItemPacketInvalid ? 0 : inst->GetSerialNumber()).c_str(),
