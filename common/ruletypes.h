...
RULE_INT(World, IPExemptionZone, 151, "Zone to exempt from checking against IP limits")
...
RULE_BOOL(Custom, BlockRaceOnAccountProgression, false, "Enable to block races out of era for Ret-style account Progression: Key is 'AccountID'-Account-Expansion")
RULE_BOOL(Custom, BlockClassOnAccountProgression, false, "Enable to block classes out of era for Ret-style account Progression: Key is 'AccountID'-Account-Expansion")
