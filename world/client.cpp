...
)
{
	...
	if (RuleB(Custom, MulticlassingEnabled)) {
		std::string insertQuery = StringFormat("REPLACE INTO data_buckets (`key`, value, expires, character_id, npc_id, bot_id) VALUES ('GestaltClasses', '%s', 0, %d, 0, 0)", p_player_profile_struct->classes, character_id);
