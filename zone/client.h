...
public:
	...
	*/
	...
	bool IsSeasonal() { return (Strings::ToBool(GetBucket("SeasonalCharacter"), 0) == RuleI(Custom, EnableSeasonalCharacters)); }

	// Hardcore Helper Methods
	bool IsHardcore() { return Strings::ToBool(GetBucket("DiscordantCharacter"), 0); }
