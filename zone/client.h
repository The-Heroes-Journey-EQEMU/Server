...
public:
	...
	*/
	...
	bool IsSeasonal() { return Strings::ToInt(GetBucket("SeasonalCharacter"), 0) == RuleI(Custom, EnableSeasonalCharacters); }

	// Hardcore Helper Methods
	bool IsHardcore() { Strings::ToInt(GetBucket("DiscordantCharacter"), 0); }
